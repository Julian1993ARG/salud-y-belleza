export default function PrivacityPolity () {
  return (
    <section>
      <p>
        Política de privacidad de Ferreyra Mara Silvina

        Esta Política de privacidad describe cómo se recopila, utiliza y comparte su información personal cuando visita o hace una compra en https://salud-y-belleza.vercel.app/ (denominado en lo sucesivo el “Sitio”).
        ...
        CONTÁCTENOS
        Para obtener más información sobre nuestras prácticas de privacidad, si tiene alguna pregunta o si desea presentar una queja, contáctenos por correo electrónico a julianmartinez_93@hotmail.com o por correo mediante el uso de la información que se proporciona a continuación:

        Pueyrredon 545, Oliva, X, 5980, Argentina
      </p>
    </section>
  );
}
